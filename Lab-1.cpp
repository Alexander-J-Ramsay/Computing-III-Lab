...
int main(void)
{
    ...
    while (interest != 0) //Loop continues until the user stops by entering interest as 0.
    {
        interest /= 100; //Convert the interest to a decimal value.
    ...
    return 0; //Terminate program once user inputs 0 for interest.
}
